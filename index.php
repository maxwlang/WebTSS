...
<body>
    ...
    <div class="container">
			...
			?>
				<div class="panel panel-default">
				  ...
				  <div class="panel-body">
					<ul>
						<li>
							WebTSS is an <a href="https://github.com/maxwlang/WebTSS">open-source</a> SHSH blob management program for the web.
						</li>
						<li>
        ...
        <div class="container">
        	<center>
        		<small><a href="https://github.com/maxwlang/WebTSS">WebTSS</a> is copyright (c) 2016-<?php echo date("Y"); ?> <a href="https://github.com/maxwlang">maxwlang</a></small>
        		<br/>
